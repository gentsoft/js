...
const popup = function() {
    ...
    const getVideoContent = function(link) {
        ...
        let html = `
        <iframe width="560" height="315" src="https://www.youtube.com/embed/d9iLPs1Tjkc/#${id}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        `;  
